...
App docs、project instructions、event completion rules 和 workflow routing 保持为各自 instruction layers，并承担各自职责。
...
Workspace app prompt docs 描述 App 能力；可复用任务 SOP 位于 workflow primitive specs。

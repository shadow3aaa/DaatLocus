  ...
  "en-US": {
    translation: {
      ...
      share: {
        ...
        thisSession: "Share this session",
        gateTitle: "Open shared session",
        gateDescription:
          "Enter the 4-digit PIN the owner gave you. The link itself never contains the PIN.",
        pinLabel: "PIN",
        unlock: "Unlock",
        dialogTitle: "Share a session",
        selectAllLabel: "Sessions to share",
        selectAll: "Select all",
        clearAll: "Clear all",
        untitledSession: "Untitled session",
        unrestrictedLabel: "Do not restrict sessions",
        next: "Continue",
        back: "Back",
        create: "Create share",
        confirmStatement:
          "Sharing a session hands over control of the agent: the visitor can read the full history and send instructions that trigger tools. Only share with people you trust.",
        confirmUnrestricted:
          "Scope: every session, including future ones.",
        confirmCount: "Scope: {{count}} selected session(s).",
        preparing: "Preparing the tunnel…",
        pinHeading: "PIN",
        qrAlt: "Share link QR code",
        countdown: "Expires in {{minutes}}:{{seconds}}",
        regenerate: "Regenerate",
        retry: "Retry",
        failedFallback: "The tunnel could not be established.",
        failedCode: "Reason code: {{code}}",
      },
      study: {
        pageAria: "Study knowledge graph",
        loadingGraph: "Loading the knowledge graph",
        loadErrorTitle: "Unable to load the study graph",
        emptyGraphTitle: "The knowledge graph is empty",
        emptyGraphDescription:
          "Add modules and nodes through the chat, or extend an existing field.",
        chatConnecting: "Connecting to the study session",
        overviewTab: "Overview",
        chatTab: "Chat",
        selectNodeTitle: "Select a node",
        selectNodeDescription:
          "Pick a node in the circle to read its description and relations.",
        ...
        searchAria: "Search knowledge nodes",
        searchNoMatches: "No matching nodes",
        sidebarEmpty: "Open the Study tab to load the knowledge network.",
        transfer: {
          actions: "Graph file actions",
          ...
          newModule: "New module named after the vault",
          existingModule: "Existing module",
          preview: "Preview import",
          previewing: "Scanning the vault…",
          notesFound: "Notes",
          newNodes: "New nodes",
          duplicates: "Duplicates",
          dangling: "Dangling links",
          skipped: "Skipped files",
          truncated: "The vault is large; only the first notes were scanned.",
          duplicatesTitle: "Duplicate candidates",
          danglingTitle: "Dangling links",
          skippedTitle: "Skipped files",
          mergeDuplicates: "Merge duplicate note bodies",
          confirmImport: "Import {{count}} nodes",
          back: "Back",
          importing: "Importing…",
          importDone:
            "Imported {{created}} nodes into {{module}}, merged {{merged}}, created {{edges}} relations.",
          close: "Close",
          exportButton: "Export",
          exporting: "Building the archive…",
          exportReady: "Downloaded {{name}} ({{size}} KB)",
          scopeLabel: "Scope",
          scopeAll: "Whole graph",
          formatLabel: "Format",
          formatVault: "Obsidian vault (.zip)",
          formatJson: "JSON backup (.zip)",
          includeQuestions: "Include question bank (JSON only)",
        },
      },
      app: {
      ...
      status: {
        ...
        noItems: "No items.",
        statusTitle: "STATUS",
        statusSubtitle: "Current session runtime facts.",
        modelUsage: "Model usage",
        modelUsageAria: "{{role}} model usage",
        noTokenUsageRecordedYet: "No token usage recorded yet.",
        planSection: "Plan",
        noActivePlanItems: "No active plan items.",
        contextSection: "Context",
        sleepStatus: "SLEEP STATUS",
        sleepStatusSubtitle: "Background optimization state.",
        noActivePlan: "No active plan.",
        noFileChanges: "No file changes",
        noOutput: "(no output)",
        noActivityYet: "No activity yet",
        selectAgentToInspect: "Select an agent to inspect its activity.",
        waitingForFirstAgent: "Waiting for the first agent",
      ...
      chat: {
        openChatWith: "Chat with {{agent}}",
        sendMessageToAgent: "Send message to agent",
        attachImages: "Attach images",
        attachImage: "Attach image",
        attachFiles: "Attach files…",
        fileFallback: "file",
        attachmentLimit: "You can attach up to {{count}} files per message.",
        message: "Message",
        imageSelected: "Image selected",
        removeAttachment: "Remove {{name}}",
        imageFallback: "image",
        pendingUserInputs: "Pending user inputs",
        dragPendingInput: "Drag pending input {{position}}",
        runPendingInputNow: "Run pending input {{position}} now",
        runQueuedInputNow: "Run this queued input now",
        moreActions: "More actions",
        moreActionsForPendingInput: "More actions for pending input {{position}}",
        ...
        skills: "Skills",
        workflows: "Workflows",
        skillsLoaded: "{{count}} loaded. Choose a skill to inspect.",
        workflowsLoaded: "{{count}} loaded. Choose a workflow to inspect.",
        noSkillsLoaded: "No skills loaded.",
        noWorkflowsLoaded: "No workflows loaded.",
        noMatches: "No matches.",
        typeToSearchSkills: "Type to search skills",
        toggleAutoUse: "Toggle automatic use for loaded skills.",
        dismissCommandFeedback: "Dismiss command feedback",
        closePanel: "Close {{title}}",
        copy: "Copy",
        copyCode: "Copy {{label}} code",
        scrollableMarkdownTable: "Scrollable markdown table",
        openWorkflowPreview: "Open workflow preview",
        backToWorkflowPreview: "Back to workflow preview",
        dragToReorderTitle: "Drag to reorder",
        onlyOneQueuedInput: "Only one queued input",
        workflowNotLoaded: "The selected workflow is no longer loaded.",
        returnToWorkflows: "Return to /workflows and choose a currently loaded workflow.",
        agentPanelAria: "Agent",
        moreLines: "… {{count}} more line(s)",
      },
      modelSwitch: {
        title: "Switch model",
        openAria: "Current model: {{model}}. Click to switch.",
  ...
  "zh-CN": {
    translation: {
      common: {
        ...
        toggleSidebar: "切换侧边栏",
        sidebarLabel: "侧边栏",
        sidebarMobileDescription: "显示移动端侧边栏。",
      },
      document: {
        signIn: "登录",
      },
      ...
      share: {
        ...
        gateTitle: "打开分享会话",
        gateDescription:
          "请输入分享者给你的 4 位 PIN。链接本身不包含 PIN。",
        pinLabel: "PIN",
        unlock: "解锁",
        dialogTitle: "分享会话",
        selectAllLabel: "要分享的会话",
        selectAll: "全选",
        clearAll: "取消全选",
        untitledSession: "未命名会话",
        unrestrictedLabel: "不限制会话",
        next: "继续",
        back: "返回",
        create: "创建分享",
        confirmStatement:
          "分享一个会话等于交出对 agent 的控制权：访客可以读取完整历史，并可发送指令、触发工具。请只分享给你信任的人。",
        confirmUnrestricted: "范围：所有会话，包括之后新建的会话。",
        confirmCount: "范围：已选择 {{count}} 个会话。",
        preparing: "正在准备隧道…",
        pinHeading: "PIN",
        qrAlt: "分享链接二维码",
        countdown: "{{minutes}}:{{seconds}} 后过期",
        regenerate: "重新生成",
        retry: "重试",
        failedFallback: "无法建立隧道。",
        failedCode: "原因代码：{{code}}",
      },
      study: {
        pageAria: "学习知识图谱",
        loadingGraph: "正在加载知识图谱",
        loadErrorTitle: "无法加载学习图谱",
        emptyGraphTitle: "知识图谱为空",
        emptyGraphDescription: "通过对话创建模块与节点，或从已有领域向外扩展。",
        chatConnecting: "正在连接学习会话",
        overviewTab: "简介",
        chatTab: "对话",
        selectNodeTitle: "选择一个节点",
        selectNodeDescription: "在圆圈中选择节点，查看简介与关系。",
        exitFocus: "退出聚焦",
        understandingValue: "{{value}}%",
        prerequisitesLabel: "前置",
        relatedLabel: "相关",
        followUpsLabel: "后置",
        searchPlaceholder: "搜索节点",
        searchAria: "搜索知识节点",
        searchNoMatches: "没有匹配的节点",
        sidebarEmpty: "打开「学习」标签页以加载知识网络。",
        transfer: {
          actions: "图谱文件操作",
          ...
          dangling: "悬空链接",
          skipped: "跳过文件",
          truncated: "仓库较大，仅扫描了前面的笔记。",
          duplicatesTitle: "疑似重复",
          danglingTitle: "悬空链接",
          skippedTitle: "跳过文件",
          mergeDuplicates: "重复项合并正文",
          confirmImport: "导入 {{count}} 个节点",
          back: "返回",
          importing: "正在导入…",
          importDone:
            "已向「{{module}}」导入 {{created}} 个节点、合并 {{merged}} 个、建立 {{edges}} 条关系。",
          close: "关闭",
          exportButton: "导出",
          exporting: "正在打包…",
          exportReady: "已下载 {{name}}（{{size}} KB）",
          scopeLabel: "范围",
          scopeAll: "全部",
          formatLabel: "格式",
          formatVault: "Obsidian 仓库 (.zip)",
          formatJson: "JSON 备份 (.zip)",
          includeQuestions: "包含题库（仅 JSON）",
        },
      },
      app: {
      ...
      status: {
        ...
        noItems: "无条目。",
        statusTitle: "状态",
        statusSubtitle: "当前会话运行时信息。",
        modelUsage: "模型用量",
        modelUsageAria: "{{role}} 模型用量",
        noTokenUsageRecordedYet: "尚未记录 token 用量。",
        planSection: "计划",
        noActivePlanItems: "暂无计划条目。",
        contextSection: "上下文",
        sleepStatus: "休眠状态",
        sleepStatusSubtitle: "后台优化状态。",
        noActivePlan: "暂无活动计划。",
        noFileChanges: "无文件更改",
        noOutput: "（无输出）",
        noActivityYet: "暂无活动",
        selectAgentToInspect: "选择一个 Agent 查看其活动。",
        waitingForFirstAgent: "等待第一个 Agent",
      ...
      chat: {
        openChatWith: "与 {{agent}} 聊天",
        sendMessageToAgent: "向 Agent 发送消息",
        attachImages: "附加图片",
        attachImage: "附加图片",
        attachFiles: "附加文件…",
        fileFallback: "文件",
        attachmentLimit: "每条消息最多附加 {{count}} 个文件。",
        message: "消息",
        imageSelected: "已选择图片",
        removeAttachment: "移除 {{name}}",
        imageFallback: "图片",
        pendingUserInputs: "待处理用户输入",
        dragPendingInput: "拖动待处理输入 {{position}}",
        runPendingInputNow: "立即运行待处理输入 {{position}}",
        runQueuedInputNow: "立即运行此排队输入",
        moreActions: "更多操作",
        moreActionsForPendingInput: "待处理输入 {{position}} 的更多操作",
        editMessage: "编辑消息",
        dismissMessage: "忽略消息",
        clearQueue: "清空队列",
        ...
        skills: "技能",
        workflows: "工作流",
        skillsLoaded: "已加载 {{count}} 个，选择一个技能查看。",
        workflowsLoaded: "已加载 {{count}} 个，选择一个工作流查看。",
        noSkillsLoaded: "未加载任何技能。",
        noWorkflowsLoaded: "未加载任何工作流。",
        noMatches: "无匹配。",
        typeToSearchSkills: "输入以搜索技能",
        toggleAutoUse: "切换已加载技能的自动使用。",
        dismissCommandFeedback: "忽略命令反馈",
        closePanel: "关闭 {{title}}",
        copy: "复制",
        copyCode: "复制 {{label}} 代码",
        scrollableMarkdownTable: "可滚动 Markdown 表格",
        openWorkflowPreview: "打开工作流预览",
        backToWorkflowPreview: "返回工作流预览",
        dragToReorderTitle: "拖动以重新排序",
        onlyOneQueuedInput: "仅一个排队输入",
        workflowNotLoaded: "所选工作流已不再加载。",
        returnToWorkflows: "返回 /workflows 并选择一个当前已加载的工作流。",
        agentPanelAria: "Agent",
        moreLines: "… 还有 {{count}} 行",
      },
      modelSwitch: {
        title: "切换模型",
        openAria: "当前模型：{{model}}，点击切换",
        unknownModel: "未知模型",
        unavailable: "模型列表不可用",
        loading: "加载模型中…",
      },
